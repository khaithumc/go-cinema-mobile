...
import 'package:data/mappers.dart' show notificationResponseToNotification;
import 'package:data/remote/auth_client.dart';
import 'package:data/remote/base_url.dart';
import 'package:data/remote/response/notification_response.dart';
import 'package:domain/model/notification.dart';

class FcmNotificationManager {
  static const _debugTag = '✉️ FcmNotificationManager';

  static const channelId = 'com.go.cinema';
  static const channelName = 'com.go.cinema.channel';
  static const channelDescription = 'Enjoy movie notification channel';
  static const _notificationIdKey = 'com.go.cinema.notification.id';
